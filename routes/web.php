...
Route::get('/', function () {
    ...
    $pokemon_first = ["Bulbasaur", "Ivysaur", "Venusaur", "Charmander", "Charmeleon",
    ...
    return view('firstgen', compact("pokemon_first", "showPokemon"));
})->name('firstgen');


Route::get("/secondgen", function() {

    $pokemon_second = ["Chikorita", "Bayleef", "Meganium", "Cyndaquil", "Quilava",
    ...
    return view("secondgen", compact("pokemon_second", "showPokemon"));

})->name('secondgen');


Route::get("/thirdgen", function() {

    $pokemon_third = ["Treecko", "Grovyle", "Sceptile", "Torchic", "Combusken",
    ...
    return view("thirdgen", compact("pokemon_third", "showPokemon"));

})->name('thirdgen');


Route::get("/fourthgen", function() {

    $pokemon_fourth = ["Turtwig", "Grotle", "Torterra", "Chimchar", "Monferno",
    ...
    "Wormadam", "Mothim", "Combee", "Vespiquen", "Pachirisu",
    "Buizel", "Floatzel", "Cherubi", "Cherrim", "Shellos",
    ...
    "Rotom", "Uxie", "Mesprit", "Azelf", "Dialga", "Palkia",
    "Heatran", "Regigigas", "Giratina", "Cresselia", "Phione",
    "Manaphy", "Darkrai", "Shaymin", "Arceus"];

    $showPokemon = true;

    return view("fourthgen", compact("pokemon_fourth", "showPokemon"));

})->name('fourthgen');


Route::get("/fifthgen", function() {

    $pokemon_fifth = ["Victini", "Snivy", "Servine", "Serperior", "Tepig", "Pignite",
    ...
    return view("fifthgen", compact("pokemon_fifth", "showPokemon"));

})->name('fifthgen');


Route::get("/sixthgen", function() {

    $pokemon_sixth = ["Chespin", "Quilladin", "Chesnaught", "Fennekin", "Braixen",
    ...
    "Flabébé", "Floette", "Florges", "Skiddo", "Gogoat", "Pancham",
    ...
    "Sylveon", "Hawlucha", "Dedenne", "Carbink", "Goomy", "Sliggoo",
    ...
    return view("sixthgen", compact("pokemon_sixth", "showPokemon"));

})->name('sixthgen');


Route::get("/seventhgen", function() {

    $pokemon_seventh = ["Rowlet", "Dartrix", "Decidueye", "Litten", "Torracat",
    ...
    return view("seventhgen", compact("pokemon_seventh", "showPokemon"));

})->name('seventhgen');


Route::get("/eighthgen", function() {

    $pokemon_eighth = ["Grookey", "Thwackey", "Rillaboom", "Scorbunny", "Raboot",
    ...
    return view("eighthgen", compact("pokemon_eighth", "showPokemon"));
